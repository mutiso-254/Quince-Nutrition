...
export default function Contact() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log("We are here trying to send the API request. ")
    ...
    <div className="bg-stone-50 pt-20">
      <div className="bg-emerald-900 text-white py-20 text-center relative overflow-hidden">
        <div className="absolute inset-0 opacity-20">
          <img
            src={new URL('../images/Contact Us Image.jpg', import.meta.url).href}
            className="w-full h-full object-cover"
          />
        </div>
        <div className="relative z-10">
          <h1 className="font-serif text-4xl md:text-6xl mb-4">Contact Us</h1>
          <p className="text-emerald-100 text-lg">We'd love to hear from you.</p>
        </div>
      </div>
        ...
        <div className="bg-white rounded-[2.5rem] overflow-hidden shadow-xl border border-emerald-100">
          <div className="grid lg:grid-cols-5">
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-8">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <p className="font-medium text-emerald-100 text-sm uppercase tracking-wider mb-1">Location</p>
                      <p className="text-white text-lg leading-snug">{COMPANY_INFO.location}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <p className="font-medium text-emerald-100 text-sm uppercase tracking-wider mb-1">Call Us</p>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <p className="font-medium text-emerald-100 text-sm uppercase tracking-wider mb-1">Email Us</p>
            ...
            <div className="lg:col-span-3 p-12 bg-white relative">
              <h3 className="font-serif text-3xl text-stone-900 mb-8">Send us a message</h3>
              ...
              <AnimatePresence mode="wait">
                {formStatus === 'success' ? (
                  ...
                  >
                    ...
                    <h4 className="text-2xl font-serif text-stone-900 mb-2">Message Sent!</h4>
                  ...
                  >
                    ...
                    <div>
                      <label className="block text-sm font-medium text-stone-700 mb-2">Service Interest</label>
                      <select
                        value={service}
