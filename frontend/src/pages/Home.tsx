...
const heroSlides = [
  {
    ...
    description:
      "Get one-on-one guidance from our certified nutritionists and wellness experts. We help you create sustainable lifestyle changes through personalized counselling sessions tailored to your unique needs.",
  },
  {
    id: 2,
    image:
    ...
    description:
      "We provide expert-driven nutrition solutions, wellness coaching, and evidence-based guidance to help you achieve optimal health and lasting vitality.",
  },
  {
    id: 3,
    image:
    ...
    description:
      "Specialized programs for diabetes management, hypertension, and other chronic conditions. Our evidence-based approach helps you take control of your health.",
  },
  {
    id: 4,
    image:
    ...
    description:
      "Comprehensive workplace wellness programs that boost employee health, productivity, and morale through nutrition education and mental health support.",
  },
];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-stone-600">
              We go beyond basic diet plans. We offer a holistic approach to
              health that integrates nutrition, mental well-being, and lifestyle
              changes.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                img: new URL(
                  "../images/Holistic Approach Image.jpg",
                  import.meta.url,
                ).href,
              },
            ].map((feature, idx) => (
              <motion.div
                ...
                className="group relative overflow-hidden rounded-3xl aspect-4/5 md:aspect-auto md:h-125"
              >
                <img
                  src={feature.img}
                  alt={feature.title}
                ...
                <div className="absolute bottom-0 left-0 p-8 text-white">
                  ...
                  <Link
                    to="/about"
                    className="text-sm font-medium text-emerald-300 hover:text-emerald-200 flex items-center"
                  >
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-stone-600 mb-8 text-lg">
                Whether you need help managing a health condition, looking for
                high-quality supplements, or seeking corporate wellness
                programs, we have you covered.
              </p>
              <div className="space-y-4">
                {[
                  ...
                  >
                    <span className="font-medium text-stone-800 group-hover:text-emerald-900">
                      {item.label}
                    </span>
      ...
      <section className="py-24 bg-emerald-900 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-emerald-100 text-lg mb-10">
            Join us at Quince Nutrition and let's work together towards a
            healthier you and a healthier community.
          </p>
          <Link
            to="/contact"
